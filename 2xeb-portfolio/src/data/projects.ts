...
export const PROJECTS: Project[] = [
  ...
  // --- SWE PROJECTS ---
  {
    ...
    tags: ['Next.js', 'React', 'TypeScript', 'Firebase', 'Firestore', 'Gemini', 'PWA', 'AI'],
    createdAt: '2025-06-01',
    imageUrl: `data:image/svg+xml,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600"><defs><linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#16A34A"/><stop offset="100%" stop-color="#0A0A0A"/></linearGradient></defs><rect fill="url(#g)" width="800" height="600"/><text x="400" y="280" text-anchor="middle" fill="#fff" font-family="monospace" font-size="56" font-weight="bold" opacity="0.9">FIDEL</text><text x="400" y="330" text-anchor="middle" fill="#fff" font-family="monospace" font-size="16" opacity="0.5">AMHARIC LEARNING</text></svg>`)}`,
    status: 'live',
    isExternal: true,
    externalUrl: 'https://fidel-beta.up.railway.app',
    role: 'Founder / Lead Engineer'
  },
  {
    id: 2,
